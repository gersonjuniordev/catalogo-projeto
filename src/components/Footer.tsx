    ...
    <footer className="bg-gradient-to-br from-secondary-800 via-secondary-900 to-secondary-950 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-secondary-200">
              Somos especializados em fornecer os melhores caminhões para sua necessidade.
              Qualidade e confiança são nossa prioridade.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-secondary-200">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>contato@ancoratransportes.com</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="h-5 w-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-secondary-200 hover:text-primary-400 transition-colors duration-200">
        ...
        <div className="mt-12 pt-8 border-t border-secondary-700 text-center text-secondary-400">
          <p>&copy; {new Date().getFullYear()} Ancora Transportes Ltda. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  )
